...
import { Boxes, Mail, Lock, Loader2, ArrowLeft, ChevronRight, MapPin, Store } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <Card className="border-none shadow-sm rounded-[2.5rem] bg-white overflow-hidden">
          <CardHeader className="p-10 pb-0 bg-slate-50/50">
            <CardTitle className="text-lg font-black text-primary italic uppercase tracking-tighter">Identity Sync</CardTitle>
            <CardDescription className="font-medium">Enter your registered branch credentials.</CardDescription>
          </CardHeader>
